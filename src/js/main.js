    ...
    const addForHTMLBasket = () => {
        ...
        basket.forEach((item) => {
           ...
           <div class="basket__card">
                        ...
                        <button data-id="${item.id}" type="button" class="basket__card-btn">X</button>
                    </div>
        `
        })
        ...
        let cardBtnForDelete = document.querySelectorAll('.basket__card-btn')

        Array.from(cardBtnForDelete).forEach((btn) => {
